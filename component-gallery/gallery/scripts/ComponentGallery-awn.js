/* Declares the ComponentGallery Audio Worklet Node */

class ComponentGalleryController extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "ComponentGallery", options);
  }
  ...
  static importScripts (actx) {
    ...
    return new Promise( (resolve) => {
      actx.audioWorklet.addModule(origin + "scripts/ComponentGallery-wam.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
      actx.audioWorklet.addModule(origin + "scripts/ComponentGallery-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
