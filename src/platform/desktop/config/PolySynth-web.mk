...
SEA_UTIL_INCLUDE = $(PROJECT_ROOT)/../../../libs/SEA_Util/include
UI_CONTROLS_INCLUDE = $(PROJECT_ROOT)/../../../UI/Controls

WAM_CFLAGS += -I$(IPLUG_SYNTH_PATH) -I$(SEA_DSP_INCLUDE) -I$(SEA_UTIL_INCLUDE)

WEB_CFLAGS += -DIGRAPHICS_NANOVG -DIGRAPHICS_GLES2 -I$(SEA_DSP_INCLUDE) -I$(SEA_UTIL_INCLUDE) -I$(UI_CONTROLS_INCLUDE)

WAM_LDFLAGS += -O3 -s EXPORT_NAME="'ModuleFactory'" -s ASSERTIONS=0

WEB_LDFLAGS += -O3 -s ASSERTIONS=0 -s ALLOW_MEMORY_GROWTH=1 -s INITIAL_MEMORY=134217728
