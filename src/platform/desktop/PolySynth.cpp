...
#if IPLUG_DSP
void PolySynth::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void PolySynth::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
  mMeterSender.Reset(GetSampleRate());
}

void PolySynth::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void PolySynth::OnParamChangeUI(int paramIdx, EParamSource source)
{
  #if IPLUG_EDITOR
...
bool PolySynth::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
