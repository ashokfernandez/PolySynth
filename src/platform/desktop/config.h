...
#define SHARED_RESOURCES_SUBPATH "PolySynth"
...
#define AUV2_ENTRY PolySynth_Entry
#define AUV2_ENTRY_STR "PolySynth_Entry"
#define AUV2_FACTORY PolySynth_Factory
#define AUV2_VIEW_CLASS PolySynth_View
