...
class ComponentGallery final : public iplug::Plugin {
public:
  ...
  void OnParamChange(int paramIdx, EParamSource source,
...
private:
  ...
  bool mVRTCaptureFinished = false;
  int mCurrentVRTComponent = 0;
