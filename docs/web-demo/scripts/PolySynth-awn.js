/* Declares the PolySynth Audio Worklet Node */

class PolySynthController extends WAMController {
  ...
  static importScripts(actx) {
    ...
    return new Promise((resolve, reject) => {
      actx.audioWorklet.addModule(origin + "scripts/PolySynth-wam.js").then(() => {
        actx.audioWorklet.addModule(origin + "scripts/wam-processor.js").then(() => {
          actx.audioWorklet.addModule(origin + "scripts/PolySynth-awp.js").then(() => {
            resolve();
          }).catch((e) => { console.error("Failed to load PolySynth-awp.js", e); reject(e); });
        }).catch((e) => { console.error("Failed to load wam-processor.js", e); reject(e); });
      }).catch((e) => { console.error("Failed to load PolySynth-wam.js", e); reject(e); });
    })
  }
