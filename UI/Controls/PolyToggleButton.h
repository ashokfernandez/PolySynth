...
public:
  ...
  void Draw(IGraphics& g) override {
    ...
    const IColor bg = active ? PolyTheme::ToggleActiveBG : PolyTheme::ToggleInactiveBG;
    ...
    g.DrawText(IText(PolyTheme::FontControl, fg, "Roboto-Bold", EAlign::Center), mLabel.Get(),
               mRECT);
  }
