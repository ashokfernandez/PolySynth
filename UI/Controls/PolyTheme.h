...
// ── Control face colors ───────────────────────────────────────
static const IColor ControlFace    = IColor(255, 230, 228, 222);  // IVStyle kFG – button/tab faces
static const IColor TabInactiveBG  = IColor(255, 220, 218, 212);  // Slightly darker for unselected tabs
...
static constexpr float SectionTitleH   = 36.f;  // Height reserved for section title
